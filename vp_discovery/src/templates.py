...
def parse_template_1(soup: BeautifulSoup) -> list:
    """
...
def parse_template_2(soup: BeautifulSoup) -> list:
    """
...
def parse_template_3(soup: BeautifulSoup) -> list:
    """
...
def parse_template_4(soup: BeautifulSoup) -> list:
    """
...
# TODO: protocol input value
def parse_template_5(soup: BeautifulSoup) -> list:
    """
...
def parse_template_6(soup: BeautifulSoup) -> list:
    """
...
def parse_template_7(soup: BeautifulSoup) -> list:
    """
    Parse the template #6, which is used by OPEN BGPD open-source project.
    Typical API format: 
    Note: some webpages already have /cgi-bin/bgplg as the prefix.
